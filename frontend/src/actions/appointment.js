...
export const getAppointmentByLoggedUserId = () => async (dispatch) => {
  try {
    const res = await axios.get(baseurl + `/api/appointment/my-appointments`);
...
export const getAppointmentByUserId = (client_id) => async (dispatch) => {
  try {
    const res = await axios.get(baseurl + `/api/appointment/${client_id}`);
...
//Get All Appointments of a Day
export const getAppointments = (date) => async (dispatch) => {
  try {
    const res = await axios.get(baseurl + `/api/appointment/${date}`);
...
export const getAppointmentById = (appointment_id) => async (dispatch) => {
  try {
    const res = await axios.get(baseurl + `/api/appointment/${appointment_id}`);
  ...
  if (
    ...
    try {
      const res = await axios.delete(
        baseurl + `/api/appointment/${appointment_id}`
      );
